...
use App\Modules\Systems\Models\Entities\Notes;
use App\Modules\Systems\Models\Entities\Status;
...
class NotesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Systems::notes.notesList', ['notes' => $notes]);
    }
    ...
    {
        $statuses = Status::all();
        return view('Systems::notes.create', [ 'statuses' => $statuses ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('Systems::notes.noteShow', [ 'note' => $note ]);
    }
    ...
    public function edit($id)
    {
        $note = Notes::find($id);
        $statuses = Status::all();
        return view('Systems::notes.edit', [ 'statuses' => $statuses, 'note' => $note ]);
    }
