...
class MailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Systems::email.index', ['emailTemplates' => $emailTemplates]);
    }
    ...
    {
        return view('Systems::email.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('Systems::email.show', [ 'template' => $template ]);
    }
    ...
    {
        $template = EmailTemplate::find($id);
        return view('Systems::email.edit', [ 'template' => $template ]);
    }
    ...
    public function prepareSend($id){
        $template = EmailTemplate::find($id);
        return view('Systems::email.send', [ 'template' => $template ]);
    }
