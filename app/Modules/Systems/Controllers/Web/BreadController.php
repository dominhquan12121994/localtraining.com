...
class BreadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Systems::form.index', ['forms' => Form::all()]);
    }
    ...
    {
        return view('Systems::form.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->has('marker') && $request->input('marker') === 'selectModel'){
            ...
            if(empty($model)){
                ...
                return view('Systems::form.create2', [
    ...
    public function destroy($id, Request $request)
    {
        ...
        if($request->has('marker')){
            ...
            return view('Systems::form.delete', ['id' => $id, 'formName' => $form->name]);
        }
    }
}
