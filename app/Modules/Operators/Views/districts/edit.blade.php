                ...
                <div class="card">
                    <form method="POST" action="/districts/{{ $district->id }}">
                        <div class="card-header">
                          <i class="fa fa-align-justify"></i> {{ __('Edit') }}: {{ $district->title }}
                        </div>
                        <div class="card-body">
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <select class="form-control" id="select1" name="p_id" value="{{ $district->p_id }}">
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    <label>Code</label>
                                    <input class="form-control @error('code') is-invalid @enderror" type="text" placeholder="{{ __('Code') }}" name="code" value="{{ $district->code }}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    <label>Name</label>
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="{{ __('Name') }}" name="name" value="{{ $district->name }}" required>
                                </div>
                            </div>
