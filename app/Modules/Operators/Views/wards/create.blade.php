                ...
                <div class="card">
                    <form method="POST" action="{{ route('wards.store') }}">
                        <div class="card-header">
                          <i class="fa fa-align-justify"></i> {{ __('Create Ward') }}</div>
                        <div class="card-body">
                            @csrf
                            <div class="form-group row">
                                <div class="col">
                                    <label for="select1">Province</label>
                                    <select class="form-control" id="select1" name="p_id" onchange="changeDistricts()">
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <select class="form-control" id="select2" name="d_id">
