...
class MenuTest extends TestCase
{
    ...
    */
    ...
    public function testMenuSwitch(){
        ...
        $this->assertDatabaseMissing('system_menu_role',['menus_id' => $menuElement->menus_id, 'role_name' => 'guest']);
        $response = $this->actingAs($user)->get('menu/selected/switch?role=guest&id=' . $menuElement->menus_id);
        $this->assertDatabaseHas('system_menu_role',['menus_id' => $menuElement->menus_id, 'role_name' => 'guest']);
    }
    */
}