...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    { 
        ...
        $this->endDropdown();
        $this->beginDropdown('admin', 'Operators', 'cil-memory');
            $this->insertLink('admin', 'Provinces', '/provinces');
            $this->insertLink('admin', 'Districts', '/districts');
            $this->insertLink('admin', 'Wards', '/wards');
        $this->endDropdown();
        $this->beginDropdown('admin', 'Orders', 'cil-memory');
            $this->insertLink('admin', 'Shops', '/shops');
            $this->insertLink('admin', 'Orders', '/orders');
        $this->endDropdown();
        $this->beginDropdown('admin', 'Reports', 'cil-bar-chart');
        $this->endDropdown();
